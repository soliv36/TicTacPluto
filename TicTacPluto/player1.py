    ...
    while is_end == False:
        if player.is_turn == True:
            ...
            if game_board.check_winner == True:
                ...
                print(Fore.RED +' You have won the game!')
                is_end = True

            if game_board.check_draw() == True:
                game_board.current_move = 'DRAW'
                print(Fore.RED + 'The game has ended in a draw.')
                is_end = True
            ...
            logging.info('Waiting for other players move...')
            ...
            tx_rx.tx_stop(tx_samples)

            if text == 'WIN':
                print('You Lose! Player #2 has won the game!')
                is_end = True
            elif text == 'DRAW':
